		...
		<div class="row" style="background-color: white;">
			...
			<div class="col-md-1  pull-right"
				...
				<div id="mySidenav" class="sidenav">
					...
					<a href="#">Contact</a> <br> <a href ="${pageContext.request.contextPath}/change_password">Change Password</a><a href="logout">Logout</a>
				</div>
...
<!-- ---------------------------------------TOPIC VERTICAL NAV BAR------------------------------------ -->
		...
		<div class="col-md-8 container" style="padding-left:20px; border-left: 1px solid #eee; height:100%; ">
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel" style="z-index:50;">
				...
				<div class="carousel-inner" role="listbox" id="Carusel" >
					...
					<div class="carousel-inner" role="listbox" id="Carusel">
						<div class="item active">
							<a href="#1" ><img
								src="${pageContext.request.contextPath}/resources/images/img_chania.jpg"
								alt="Chania" style="max-width: 460; height: 345;"></a>
						</div>

						<div class="item">
							<a href="#2"><img
								src="${pageContext.request.contextPath}/resources/images/img_chania2.jpg"
								alt="Chania" style="max-width: 460; height: 345;"></a>
						</div>
						...
						<div class="item">
							<a href="#3"><img
								...
								alt="Flower" style="max-width: 460; height: 345;"></a>
						</div>
			...
			<div class="dropdown" id = "drop_notes">
					...
					<img
						src="http://iconbug.com/data/21/256/3c4d4ac0f036ce984c00c8fead049901.png"
						id="download_img">
