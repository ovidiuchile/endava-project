...
<!-- ----------------------------------------------------------------- -->		
			<div class="col-md-8 container" id="big_container" style="">
			<div id="small_container">
				...
				<div id="addTechnology">
					...
					<form id= "technologyForm" name='technologyForm' enctype='application/json' action=" <c:url value='/technologies' />" method='POST' enctype='application/json'>
						<table>
							...
							<tr>
								<td>
									<input class="button_sign" name="submit" id="submitt" type = "submit" value="Add technology"/>
								</td>
							</tr>
						</table>
					</form>
				...
				<div id="addTopic">
					...
					<form name="topicForm" action=" <c:url value='/upload-topic' />" method="POST">
						<table>
							...
							<tr>
								<td>
									<input class="button_sign" name="submit" id="submitt" type="submit" value="Add topic" />
								</td>
							</tr>
						</table>
					</form>
				...
				<div id="addMaterial" style="">
					...
					<form name="materialForm" style="" action=" <c:url value='/upload-material' />" method="POST" enctype="multipart/form-data">
						<table style="">
							<tr style="">
								<td style="">Name of technology:</td>
								<td>
							...
							<tr>
								<td>
									<input class="button_sign" name="submit" id="submitt" type="submit" value="Add material" />
								</td>
							</tr>
						</table>
					</form>
